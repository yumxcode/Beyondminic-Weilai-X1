...
parser.add_argument(
    ...
    type=str,
    default=None,
    help="Local output path. Defaults to motions/<output_name>.npz.",
)
parser.add_argument(
    "--upload_to_wandb",
    action="store_true",
    help="Also upload and link the generated NPZ to a WandB registry.",
)
