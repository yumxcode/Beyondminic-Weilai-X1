...
parser.add_argument("--motion_file", type=str, default=None, help="Local path to a motion npz file (alternative to --registry_name).")
...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlOnPolicyRunnerCfg):
    ...
    # load the motion file — either from a local path or the wandb registry
    registry_name = args_cli.registry_name
    if args_cli.motion_file:
        env_cfg.commands.motion.motion_file = args_cli.motion_file
    elif registry_name:
        if ":" not in registry_name:  # append :latest if alias missing
