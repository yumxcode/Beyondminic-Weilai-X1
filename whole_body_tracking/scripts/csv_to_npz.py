...
parser.add_argument("--output_file", type=str, default=None, help="Local path to save the motion npz (skips WandB upload if set).")
parser.add_argument("--no_wandb", action="store_true", default=False, help="Skip WandB registry upload.")
...
def run_simulator(sim: sim_utils.SimulationContext, scene: InteractiveScene, joint_names: list[str]):
    ...
    while simulation_app.is_running():
        ...
        if reset_flag and not file_saved:
            ...
            # Save locally if --output_file is given, otherwise /tmp/motion.npz
            output_file = args_cli.output_file or "/tmp/motion.npz"
